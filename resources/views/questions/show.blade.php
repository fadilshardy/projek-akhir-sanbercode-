    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <a href="/komentar_pertanyaan/create/{{$question->id}}" class="btn btn-sm btn-primary mt-3">Post A
                    Reply</a> --}}
            </div>
        </div>
        ...
        <div class="card mt-2 ">
            <div class="card-header {{$jawaban->is_right_answer ? 'bg-success' : ''}}">Jawaban #{{$jawaban->user->name}}
